...
app.get("/benchmark", async (c) => {
  ...
  const NiftyData = await fetch("https://json.bselivefeeds.indiatimes.com/ET_Community/liveindices?outputtype=json&indexid=1913&exchange=50&company=true&pagesize=500&sortby=percentchange&sortorder=desc&language=&callback=objIndices.getDataCB");
  ...
  return c.json([JSONData.marketBandList
